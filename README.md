...
# значения полей 23 (vsize) и 24 (rss) равны 0. Следовательно, если возвращаемое функцией
# значение равно 0, то процесс является процессом ядра. Если возвращаемое значение больше 0,
# то процесс пользовательский. 
function is_vsz_rss {
